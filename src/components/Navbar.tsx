            ...
            <div className="w-full flex justify-between items-center max-w-7xl max-auto">
                ...
                >
                    ...
                    <p className="text-white text-[18px] font-bold cursor-pointer">
                        Shubham Kumar Sahoo <span></span>{" "}
                    </p>
                </Link>
                <ul className="list-none hidden sm:flex flex-row gap-10">
                    <li>
                        <a
                            href="https://www.linkedin.com/in/shubham-kumar-sahoo2907/"
                            target="_blank"
                    ...
                    <li>
                        <a
                            href="https://github.com/ShubhamK-2907"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <GitHub size={20}/>
                    ...
                    <li>
                        <a
                            href="https://www.instagram.com/shubhamkumar_29/"
                            target="_blank"
                            rel="noopener noreferrer"
                        >
                            <Instagram size={20}/>
